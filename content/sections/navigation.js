        ...
        <StyledContainer>
          ...
          <Mobile hide>
            <NavListWrapper>
              <ul>
                <NavItem>
                  <a href="mailto:arman.bxm@gmail.com"> Email </a>{" "}
                </NavItem>{" "}
                <NavItem>
                  <a href="tel:+917607075677"> Contact me </a>{" "}
                </NavItem>{" "}
                <ActionsContainer>
                  <a
                    href="https://drive.google.com/file/d/1gZZyFZcdHjQU4mc8RYT01YON7RBWNhJN/view?usp=drive_link"
                    target="_blank"
